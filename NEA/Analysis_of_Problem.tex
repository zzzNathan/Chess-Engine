...
\makebox[2cm]{\textbf{John:}} No problem. \par 
...
\begin{tblr}{Q[h]X}
  \altbf{Description:} & FIDE rated chess players who have made some 
  amount of tournament winnings.\\
  \altbf{How will they use it?} & They will be able to use the 
